...
// __dirname : 절대경로로 index.js가 위치한 경로
...
const uploadDetail = multer({
  storage: multer.diskStorage({
    ...
    filename: function (req, file, done) {
      ...
      const fileName = basename + "_" + Date.now() + ext; // 미니언_123453156.jpeg
...
// 파일 여러개 업로드 (name(input) 하나로 여러개의 파일을 받는 방법)
// req.files 생성
